...
C_DEPS += \
./Core/Src/Data_Processor/processor_service.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/Data_Processor/%.o Core/Src/Data_Processor/%.su Core/Src/Data_Processor/%.cyclo: ../Core/Src/Data_Processor/%.c Core/Src/Data_Processor/subdir.mk
...
clean: clean-Core-2f-Src-2f-Data_Processor

clean-Core-2f-Src-2f-Data_Processor:
	-$(RM) ./Core/Src/Data_Processor/processor_service.cyclo ./Core/Src/Data_Processor/processor_service.d ./Core/Src/Data_Processor/processor_service.o ./Core/Src/Data_Processor/processor_service.su

.PHONY: clean-Core-2f-Src-2f-Data_Processor
